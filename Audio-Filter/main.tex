...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/srija.wav
\end{lstlisting}
...
\item
The output of the python script in Problem \ref{prob:output} is the audio file srijafiltered.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/n.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/n.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/m.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/l.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/k.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/p.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/q.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/r.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/s.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/t.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{3.6278442 }y(n - 1)\nonumber \\ &+ \brak{4.95122513}y(n - 2) \nonumber \\
	&- \brak{3.01192428 }y(n - 3) + \brak{ 0.68888769}y(n - 4) \nonumber \\
	&= \brak{2.15209512\times 10^{-5}}x(n) \nonumber \\&+ \brak{8.60838049\times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{1.29125707\times 10^{-4}}x(n - 2) \nonumber \\&+ \brak{8.60838049\times 10^{-5}}x(n - 3) \nonumber \\
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/u.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Srija04092006/EE1205/blob/main/Audio-Filter/codes/v.py
\end{lstlisting}
\begin{figure}[H]
\centering
